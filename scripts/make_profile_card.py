...
def main() -> None:
  ...
  <style>
    .ascii {{ font: 8px/6px 'SFMono-Regular', Consolas, monospace; letter-spacing: -.3px; fill: #c4adef; }}
  ...
  <path d="M16 2H868L898 32V448L868 478H16L2 464V16Z" fill="#111018" stroke="#5b4a75" stroke-width="1.4"/>
  <path d="M16 11H862L889 38M889 442L862 469H16M11 464V16" fill="none" stroke="#7b61a8" stroke-width="1" opacity=".8"/>
  <rect x="16" y="55" width="868" height="406" fill="url(#grid)" opacity=".52"/>
  <path d="M25 86h98l10 10h135M875 86h-96l-10 10h-117M25 430h108M745 430h130" fill="none" stroke="#a58ad6" stroke-width="1.15"/>
  ...
  <rect x="25" y="110" width="345" height="300" fill="#151221" stroke="#44375a"/>
  <rect x="34" y="119" width="327" height="282" fill="url(#fineGrid)" opacity=".42"/>
  <path d="M25 110h62l9 9h64M370 110h-46l-9 9h-52M25 410h64M306 410h64" fill="none" stroke="#7b61a8" stroke-width="1"/>
  <text x="42" y="132" fill="#b79ae6" class="micro">PORTRAIT / ASCII</text>
  {portrait_rows(source)}
  <path d="M396 110H875M396 400H875" stroke="#44375a" stroke-width="1"/>
  ...
  {info_rows()}
  <rect x="405" y="420" width="450" height="28" fill="#1b1724" stroke="#44375a"/>
  <circle cx="424" cy="434" r="5" fill="#9b7bd1"/><circle cx="424" cy="434" r="2" fill="#efe9ff"/>
  <text x="439" y="438" fill="#c5bbd4" class="micro">STATUS: BUILDING / LEARNING / EXPLORING</text>
  <path d="M25 458h100M715 458h160" stroke="#b79ae6" stroke-width="2"/>
</svg>'''
