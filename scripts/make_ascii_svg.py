...
def main() -> None:
  ...
  <style>.ascii {{ font: 9px/7px 'SFMono-Regular', Consolas, monospace; letter-spacing: -.35px; fill: #c4adef; }} .micro {{ font: 10px Consolas, monospace; letter-spacing: 1px; }}</style>
  <defs><pattern id="grid" width="16" height="16" patternUnits="userSpaceOnUse"><path d="M16 0H0V16" fill="none" stroke="#2b2437" stroke-width=".6"/></pattern></defs>
  <path d="M16 2H368L398 32V368L368 398H16L2 384V16Z" fill="#111018" stroke="#5b4a75" stroke-width="1.4" />
  <path d="M16 11H362L389 38M389 362L362 389H16M11 384V16" fill="none" stroke="#7b61a8" stroke-width="1" opacity=".8" />
  <rect x="16" y="56" width="368" height="316" fill="url(#grid)" opacity=".55"/>
  <path d="M22 57h83l10 10h80M378 57h-54l-10 10h-55M22 372h80M298 372h80" fill="none" stroke="#a58ad6" stroke-width="1.2"/>
  <text x="24" y="32" fill="#b79ae6" class="micro">THS // VISUAL_ID</text>
  <text x="376" y="32" text-anchor="end" fill="#a399b4" class="micro">PORTRAIT</text>
  <text x="25" y="76" fill="#e9e5f2" class="micro">ASCII SCAN / 01</text>
  {''.join(rows)}
</svg>''', encoding="utf-8")
